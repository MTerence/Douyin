...
@interface DYMainRootViewController ()<UITabBarControllerDelegate, CYLTabBarControllerDelegate>

@property (nonatomic, weak) UIButton *selectedCover;

@property (nonatomic, strong) DYTabBarController *tabBarController;

@end

@implementation DYMainRootViewController
...
- (void)createNewTabBar {
    DYTabBarController *tabBarController = [[DYTabBarController alloc] init];
